...
$query = "call obtener_historial_x_estudiante(".$value.")";
...
<html lang="en">
  <head>
    ...
    <title>Estudiante | Historial Cursos</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Historial de Cursos <small>Listado</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      En esta tabla se muestran todos los cursos que usted ha llevado hasta el momento.
                    </p>
