...
<html lang="en">
  <head>
    ...
    <title>Asistente | Búsqueda de Usuarios</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Usuarios registrados <small>Búsqueda</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      En esta tabla se muestran todos los usuarios del sistema registrados hasta el momento. Así como sus datos personales correspondientes.
                    </p>
