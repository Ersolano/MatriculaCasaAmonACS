...
<html lang="en">
  <head>
    ...
    <title>Administrador | Lista de pagos</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Pagos realizados <small>Listado</small></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      En esta tabla se muestran todos los usuarios del sistema que han realizado los pagos de los cursos hasta el momento..
                    </p>
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Primer Apellido Estudiante</th>
